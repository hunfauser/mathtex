...
\subsection{} % задания 1(a-f)

\begin{align*} % задание a
\sqrt{7 - 3x} &= 2; \\
7 - 3x &= 4; \\
-3x &= -3; \\
x &= 1;
...
\begin{align*} % задание d ПРОВЕРИТЬ
