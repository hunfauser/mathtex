...
\newpage
\section{Площадь треугольника, угол и две стороны}
...
\newpage
\section{Площадь прямоугольного треугольника по катетам}
...
\begin{center}
	...
	\begin{scriptsize}
		...
		\draw (-0.2, 1.25) node {$a$};
		\draw (1.35, -0.2) node {$b$};
	\end{scriptsize}
	\end{tikzpicture}
	\caption{Зная катеты прямоугольного треугольника, можно по формуле, найти его площадь.}
\end{center}
\end{figure}
...
\subsection{Формула площади прямоугольного треугольника}

\[ S = \frac{1}{2}ab \]

\newpage
\section{Площадь квадрата через диагональ или сторону}
...
\subsection{Формула площади квадрата через сторону a}

\[ S = a^2 \]

\subsection{Формула площади квадрата через диагональ c}
